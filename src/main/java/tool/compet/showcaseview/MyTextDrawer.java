...
class MyTextDrawer {
	...
	@DkShowcaseView.TextPosition
	private int forcedTextPosition = DkShowcaseView.UNDEFINED;

	public MyTextDrawer(Resources resources, Context context) {
	...
	public void calculateTextPosition(int canvasW, int canvasH, boolean shouldCentreText, Rect showcase) {
		...
		areas[DkShowcaseView.LEFT_OF_SHOWCASE] = showcase.left * canvasH;
		areas[DkShowcaseView.ABOVE_SHOWCASE] = showcase.top * canvasW;
		areas[DkShowcaseView.RIGHT_OF_SHOWCASE] = (canvasW - showcase.right) * canvasH;
		areas[DkShowcaseView.BELOW_SHOWCASE] = (canvasH - showcase.bottom) * canvasW;
		...
		if (forcedTextPosition != DkShowcaseView.UNDEFINED) {
			largest = forcedTextPosition;
		}

		// Position text in largest area
		switch (largest) {
			case DkShowcaseView.LEFT_OF_SHOWCASE:
			...
			case DkShowcaseView.RIGHT_OF_SHOWCASE:
				...
				break;
			case DkShowcaseView.BELOW_SHOWCASE:
				mBestTextPosition[INDEX_TEXT_START_X] = padding;
	...
	public void forceTextPosition(@DkShowcaseView.TextPosition int textPosition) {
		if (textPosition > DkShowcaseView.BELOW_SHOWCASE || textPosition < DkShowcaseView.UNDEFINED) {
